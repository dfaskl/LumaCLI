...
class CodeRetrieverTest {
    ...
    private static final String TEST_PROJECT = "/tmp/lumacli-code-retriever";
    private VectorStore store;

    @BeforeEach
    void setUp() throws Exception {
        System.setProperty("lumacli.rag.dir", "/tmp/lumacli-test-rag-retriever");
