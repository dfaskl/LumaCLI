package com.lumacli.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[lumacli] stdout reader stopped: " + e.getMessage());
            }
        }, "lumacli-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[lumacli] stderr reader stopped: " + e.getMessage());
            }
        }, "lumacli-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
