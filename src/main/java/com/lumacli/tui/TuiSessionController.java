...
import com.lumacli.tui.history.ConversationSnapshot;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    public TuiSessionController(LumaCliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "lumacli-tui-agent-runner");
