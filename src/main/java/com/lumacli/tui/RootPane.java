...
import com.lumacli.tui.pane.CenterPane;
import com.lumacli.tui.pane.FileTreePane;
import com.lumacli.tui.pane.InputBar;
import com.lumacli.tui.pane.StatusPane;
...
public class RootPane extends Panel {
    ...
    private final LumaCliConfig config;
     ...
     */
    public RootPane(LumaCliConfig config, LlmClient llmClient) {
        super();
    ...
    public boolean handleInput(KeyStroke keyStroke) {
        ...
        if (keyStroke.getKeyType() == KeyType.Character && keyStroke.isCtrlDown() && keyStroke.getCharacter() == 'P') {
            centerPane.appendSystemMessage("对话历史已持续保存到 ~/.lumacli/history/。");
            return true;
        }
