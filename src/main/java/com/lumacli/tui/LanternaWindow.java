...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(LumaCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("LumaCLI v16.0.0");
    ...
    public LumaCliConfig getConfig() {
        return config;
    }
}
