...
import com.lumacli.mcp.mention.AtMentionCompleter;
...
final class LumaCliCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    LumaCliCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
