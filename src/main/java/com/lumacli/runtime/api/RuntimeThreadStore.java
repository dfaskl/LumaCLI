...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("lumacli.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("LUMACLI_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".lumacli", "runtime").toString();
        }
