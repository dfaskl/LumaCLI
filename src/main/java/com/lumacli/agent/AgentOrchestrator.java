...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.lumacli.skill.SkillRegistry skillRegistry,
                               com.lumacli.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "lumacli-multi-agent");
            t.setDaemon(true);
            return t;
        });
