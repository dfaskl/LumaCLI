...
```text
src/main/java/com/lumacli/prompt/
...
2. 用户级覆盖：`~/.lumacli/prompts/...`
3. 项目级覆盖：`.lumacli/prompts/...`

例如：

```text
~/.lumacli/prompts/base.md
~/.lumacli/prompts/modes/agent.md
.lumacli/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.lumacli/prompts/...`
- [x] 支持项目级覆盖 `.lumacli/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
