...
新增包：`src/main/java/com/lumacli/snapshot/`
...
```text
~/.lumacli/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dlumacli.snapshot.enabled=false
-Dlumacli.snapshot.max=50
-Dlumacli.snapshot.excludes=...
```
